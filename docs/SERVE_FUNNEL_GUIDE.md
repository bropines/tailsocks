...
7.  Tap **Add**. A card's menu offers edit, copy link, pause (the rule leaves the daemon but stays in the list until resumed) and delete; the screen's menu exports the HTTPS certificate or removes every rule.
