...
- **Root Mode routing check**: A button in Diagnostics & developer that shows the live routing and firewall state of `tailscale0`, and failures now appear in the ROOT tab of the Logs screen instead of failing silently.
